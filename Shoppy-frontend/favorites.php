...
<div class="products-view" id="favorites">
    <h2 class="main-header">Your favorite products!</h2>
    <p>Don't let this deal pass you by</p>
    <div class="container" id="favorite-products-container">
    </div>
</div>
...
<script src="./assets/Js/favoriteProducts.js" type="module"></script>
